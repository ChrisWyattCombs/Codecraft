...
public class BlockStone extends Block {
	...
	static {
		try {
			stoneTexture = TextureLoader.getTexture("JPG", ResourceLoader.getResourceAsStream("Resources/Textures/Blocks/stone.jpg"));
		} catch (IOException e) {
		// TODO Auto-generated constructor stub
		}
	}
	public BlockStone(int x2, int y2, int z2) {
